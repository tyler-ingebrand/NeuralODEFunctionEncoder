...
python src/train_predictors.py --env "HalfCheetah-v3" --predictor MLP --data_type "random" 
python src/train_predictors.py --env "HalfCheetah-v3" --predictor NeuralODE --data_type "random" 
python src/train_predictors.py --env "HalfCheetah-v3" --predictor FE --data_type "random" 
python src/train_predictors.py --env "HalfCheetah-v3" --predictor FE_NeuralODE --data_type "random" 
python src/train_predictors.py --env "HalfCheetah-v3" --predictor FE_Residuals --data_type "random" 
python src/train_predictors.py --env "HalfCheetah-v3" --predictor FE_NeuralODE_Residuals --data_type "random" 
